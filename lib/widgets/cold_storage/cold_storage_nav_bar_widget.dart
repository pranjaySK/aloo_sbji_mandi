...
class ColdStorageBottomNavBarPage extends StatefulWidget {
  const ColdStorageBottomNavBarPage({super.key});

  @override
  State<ColdStorageBottomNavBarPage> createState() =>
      _ColdStorageBottomNavBarPageState();
}

class _ColdStorageBottomNavBarPageState
    extends State<ColdStorageBottomNavBarPage> {
  int _currentIndex = 0;
