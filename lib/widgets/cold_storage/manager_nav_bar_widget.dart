...
import 'package:aloo_sbji_mandi/screens/cold_storage/manager_home_screen.dart';
        ...
        children: [
          isSelected
              ? Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF0B4D1E),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Image.asset(iconPath, height: 22, color: Colors.white),
