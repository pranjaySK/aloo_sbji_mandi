...
class AlooMitraBottomNavBarPage extends StatefulWidget {
  const AlooMitraBottomNavBarPage({super.key});

  @override
  State<AlooMitraBottomNavBarPage> createState() =>
      _AlooMitraBottomNavBarPageState();
}

class _AlooMitraBottomNavBarPageState extends State<AlooMitraBottomNavBarPage> {
  int _currentIndex = 0;
